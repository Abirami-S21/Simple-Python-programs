...
for i in range(n):
    sum_no = sum_no+pow(int(no_as_str[i]),n)  #taking each digit, and converting it into integer. Using pow() function to calculate the nth time multipication of the digit and
                                      #add it to the sum_no
